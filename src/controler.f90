...
SUBROUTINE wrapping_fn(npa, nzl, nkb, mbin, arr, z_arr, GLB_arr, k_arr, PSKZ_arr, BSDZRarr, BSDZ_arr)
use param
use subr_main
implicit none
...
call reionization_21cm(arr, z_arr, GLB_arr, k_arr, PSKZ_arr, BSDZRarr, BSDZ_arr)
